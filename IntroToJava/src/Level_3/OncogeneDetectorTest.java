...
public class OncogeneDetectorTest
{
	...
	ArrayList<String> cancerSequences = new ArrayList<String>(Arrays.asList(new String[] { "ATTTGCAGG", "TGCAAATTA", "AAAGGGCCCTTT",
			"TGCGATACGTAGGACCA", "ACTCATTAGTGC", "AAACGCTAGACACACAAG", "GGGGGGGGGGGG" }));
	...
	// // The following are extra credit tests, comment out the @Ignore to run
	// them.
	// @Ignore
	// @Test(expected = NullPointerException.class)
	// public void
	// level0ExtraCreditTestOncogeneDetectorWithNullHealthySequence()
	// {
	...
	// @Test
	// public void
	// level1ExtraCreditTestOncogeneDetectorWithEmptyHealthySequence()
	// {
	// try {
	// instance.isOncogene(new ArrayList<>(), cancerSequences, "TGC");
	// fail("IllegalArgumentException not thrown as expected");
	// } catch (IllegalArgumentException e) {
	// assertEquals("healthySequences must contain at least one element",
	// e.getMessage());
	// }
	// }
	//
	...
	// @Test
	// public void
	// level1ExtraCreditTestOncogeneDetectorWithEmptyCancerSequence()
	// {
	// try {
	// instance.isOncogene(healthySequences, new ArrayList<>(), "TGC");
	// fail("IllegalArgumentException not thrown as expected");
	// } catch (IllegalArgumentException e) {
	// assertEquals("cancerSequences must contain at least one element",
	// e.getMessage());
	// }
	// }
	//
	...
	// fail("IllegalArgumentException not thrown as expected");
	// } catch (IllegalArgumentException e) {
	// assertEquals("candidate must contain only the letters A, C, G or T",
	// e.getMessage());
	// }
	// }
	//
	...
	// public void
	// level3ExtraCreditTestOncogeneDetectorWithInvalidHealthySequence()
	// {
	...
	// @Test(expected = IllegalArgumentException.class)
	// public void
	// level3ExtraCreditTestOncogeneDetectorWithInvalidCancerSequence()
	// {
	// instance.isOncogene(healthySequences, sequencesWithInvalidElement,
	// "TGC");
	// }
}
