...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		String answer = JOptionPane.showInputDialog(null, "Spell it!!!");
		// 3. If the user spelled the word correctly, speak "correct"
		if (answer.equalsIgnoreCase( "mandlebrot")){
		speak("Correct. Now give yourself a pat on the back!!!");	
		JOptionPane.showMessageDialog(null, "Correct. Now give yourself a pat on the back!!!");
		}
